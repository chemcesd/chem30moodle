...
function embedQuicktimeObjectSmile(movie) 
{	
	movie = movie.replace("smil/smil/","smil/");
...
function full(url)
{
        newwindow=window.open(url,'name','height=320,width=330,scrollbars=0,resizable=1,menubar=0,toolbar=0,status=0,location=0,directories=0');
